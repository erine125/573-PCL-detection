...
python BERT_PCL_detection.py data/split_data/train_dataset.csv data/split_data/dev_dataset.csv ../outputs/D3/BERT_output.txt 
...
python evaluation.py ../outputs/D3/BERT_output.txt data/split_data/dev_dataset.csv ../results/D3/BERT_results_scores.out
